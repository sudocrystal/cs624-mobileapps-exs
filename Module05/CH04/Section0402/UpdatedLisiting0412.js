...
/*
    Unlike margins, which specify the space between the component and its parent component, 
    padding applies from the border of the component to its children.
*/
...
const styles = StyleSheet.create({
    ...
    centeredText: {
        ...
        margin: 10,
        borderWidth: 1,
        backgroundColor: 'lightgreyyellow'
    }
});